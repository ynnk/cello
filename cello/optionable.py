...
class AbstractOption(object):
    """ Abstract option
    """
    def __init__(self, name, description, opt_type=None,  default=None, parse=None, validate=None, hidden=False):
        """
...
class ValueOption(AbstractOption):
    def __init__(self, name, desc, **kwargs):
        if not( kwargs.get("opt_type", None) ):
            pass # XXX            
            #kwargs['opt_type'] = Any
        AbstractOption.__init__(self, name, desc, **kwargs)


class EnumOption(AbstractOption):
    """ Enumerate option
    """
    def __init__(self, name, desc, enum=None, **kwargs):
        """
        :param parse: function to transform the option value from string to
             appropriate format
        :type parse: function
